...
@WebServlet("/upload")
@MultipartConfig
public class popuUp extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String Descript = request.getParameter("Descript");
	       ...
	       String sqlImageInsertDatabase="INSERT INTO packages(package_name, img , description,price) VALUES(?,?,?,?)";		      
	       ...
	       psImageInsertDatabase.setString(4,Price);
